...
const PurchaseReport = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const purchasesResponse = await axios.get("https://backdeploy.vercel.app/api/purchase/purchases");
        setPurchases(purchasesResponse.data);
        setFilteredPurchases(purchasesResponse.data);

        const itemsResponse = await axios.get("https://backdeploy.vercel.app/api/item/items");
        setItems(itemsResponse.data);

        const vendorsResponse = await axios.get("https://backdeploy.vercel.app/api/supplier/suppliers");
