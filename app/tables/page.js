...
const Tables = () => {
    ...
    const handleView = async (tableId) => {
        try {
            const response = await axios.get(`https://backdeploy.vercel.app/api/table/tables/${tableId}`);
    ...
    const handleEditSubmit = async () => {
        try {
            ...
            const response = await axios.patch(
                `https://backdeploy.vercel.app/api/table/tables/${editTable._id}`,
                formData,
                {
                    headers: {
    ...
    useEffect(() => {
        const fetchTables = async () => {
            try {
                const tablesResponse = await axios.get('https://backdeploy.vercel.app/api/table/tables');
        ...
        const fetchSections = async () => {
            try {
                const sectionsResponse = await axios.get('https://backdeploy.vercel.app/api/section');
    ...
    const handleAddSubmit = async () => {
        try {
            ...
            const response = await axios.post(
                `https://backdeploy.vercel.app/api/table/${sectionId}/tables`,
                formData,
                {
                    headers: {
                        "Content-Type": "application/json",
    ...
    useEffect(() => {
        const fetchtables = async () => {
            try {
                const response = await axios.get('https://backdeploy.vercel.app/api/table/tables');
    ...
    const confirmDelete = async () => {
        try {
            ...
            const response = await axios.delete(
                `https://backdeploy.vercel.app/api/table/tables/${tableToDelete._id}`
            );
