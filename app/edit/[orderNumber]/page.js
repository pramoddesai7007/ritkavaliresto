...
const EditOrderPage = ({ params, tableId }) => {
      ...
      try {
        if (orderNumber) {
          ...
          const orderResponse = await axios.get(
            `https://backdeploy.vercel.app/api/order/get/order/${orderNumber}`
          );
          ...
          const sectionResponse = await axios.get(
            `https://backdeploy.vercel.app/api/section/sectionlist/${tableId}`
          );
  ...
  const handleSaveBill = async () => {
    try {
      ...
      await axios.post(`https://backdeploy.vercel.app/api/logHistory/log-history`, {
      ...
      const updateOrderEndpoint = `https://backdeploy.vercel.app/api/order/update-order-by-number/${orderNumber}`;
  ...
  const handlePrintBill = async () => {
    try {
      ...
      const tableResponse = await axios.get(
        `https://backdeploy.vercel.app/api/table/tables/${tableId}`
      );
