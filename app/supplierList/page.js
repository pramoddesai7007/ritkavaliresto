...
const SupplierList = () => {
    ...
    useEffect(() => {
        const fetchSuppliers = async () => {
            try {
                const response = await axios.get('https://backdeploy.vercel.app/api/supplier/suppliers');
    ...
    const handleEditSubmit = async (e) => {
        ...
        try {
            const response = await axios.patch(
                `https://backdeploy.vercel.app/api/supplier/suppliers/${editedSupplier._id}`,
                editedSupplier
            );
    ...
    const handleDeleteConfirmed = async () => {
        try {
            ...
            await axios.delete(`https://backdeploy.vercel.app/api/supplier/suppliers/${editedSupplier._id}`);
