...
const ACForm = ({ onSubmit }) => {
    ...
    useEffect(() => { 
        const fetchSections = async () => {
            try {
                const response = await axios.get('https://backdeploy.vercel.app/api/section');
    ...
    useEffect(() => {
        const fetchACPercentage = async () => {
            try {
                const response = await axios.get(`https://backdeploy.vercel.app/api/section/${selectedSection}`);
    ...
    const handleSubmit = async (e) => {
        ...
        if (selectedSection && acPercentage !== '') {
            try {
                await axios.patch(`https://backdeploy.vercel.app/api/section/ac/${selectedSection}`, {
