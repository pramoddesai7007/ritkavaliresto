...
const Section = () => {
  ...
  const handleEditSubmit = async () => {
    ...
    try {
      ...
      await axios.patch(
        `https://backdeploy.vercel.app/api/section/${sectionToEdit._id}`,
        {
  ...
  const handleDeleteConfirmed = async () => {
    ...
    try {
      await axios.delete(
        `https://backdeploy.vercel.app/api/section/${sectionToDelete._id}`
      );
  ...
  const handleAddSubmit = async () => {
    try {
      ...
      const response = await axios.post(
        "https://backdeploy.vercel.app/api/section/create",
        formData,
        {
          headers: {
