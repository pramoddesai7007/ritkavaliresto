...
const PurchaseForm = () => {
    ...
    const fetchStockQty = async () => {
      try {
        const response = await axios.get(
          `https://backdeploy.vercel.app/api/purchase/purchase/stockQty?itemName=${formData.itemName}`
        );
  ...
  useEffect(() => {
    const fetchVendors = async () => {
      try {
        const response = await axios.get(
          "https://backdeploy.vercel.app/api/supplier/suppliers"
        );
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await axios.get(
          "https://backdeploy.vercel.app/api/item/items"
        );
  ...
  useEffect(() => {
    const fetchGSTList = async () => {
      try {
        const response = await axios.get("https://backdeploy.vercel.app/api/gst/list");
  ...
  useEffect(() => {
    const fetchUnitList = async () => {
      try {
        const response = await axios.get(
          "https://backdeploy.vercel.app/api/unit/units"
        );
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await axios.post(
        "https://backdeploy.vercel.app/api/purchase/purchase/savebill",
        data
      );
      ...
      if (parseFloat(data.total) > 0) {
        ...
        await axios.post("https://backdeploy.vercel.app/api/supplier/supplier/debit", {
          vendorName,
          amount: parseFloat(data.paidAmount),
        });
      } else {
        // If there is no paid amount, update the supplier's credit balance
        await axios.post("https://backdeploy.vercel.app/api/supplier/supplier/credit", {
          vendorName,
