...
const capitalizeFirstLetter = (str) => {
    ...
    if (name === "unit") {
      ...
      try {
        const unitDetailsResponse = await axios.get(
          `https://backdeploy.vercel.app/api/unit/units/${value}`
        );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (itemToEdit) {
        ...
        await axios.put(
          `https://backdeploy.vercel.app/api/item/items/${itemToEdit._id}`,
          formData
        );
      } else {
        // If creating, make a POST request
        await axios.post("https://backdeploy.vercel.app/api/item/items", {
          ...formData,
  ...
  const handleDeleteConfirmed = async () => {
    try {
      ...
      await axios.delete(
        `https://backdeploy.vercel.app/api/item/items/${itemIdToDelete}`
      );
  ...
  //     await axios.delete(`https://backdeploy.vercel.app/api/item/items/${itemId}`);
